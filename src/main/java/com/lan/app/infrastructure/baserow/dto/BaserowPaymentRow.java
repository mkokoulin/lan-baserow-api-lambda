...
public record BaserowPaymentRow(
    ...
    @JsonProperty("registration_id") List<BaserowLinkToTable> registrationId,
    ...
    public String registrationIdValue() {
        return registrationId == null || registrationId.isEmpty() ? null : registrationId.getFirst().value();
    }
}
